...
<table class="table table-hover table-bordered">
      ...
      <tbody>
        <tr>
          ...
          <td>无</td>
          <td>*.do</td>
          <td><a href="http://localhost:8080/M1/index.do">index.do</a></td>
        </tr>
        <tr>
          <th scope="row">2</th>
          <td>Y</td>
          ...
          <td>*.pdf</td>
          <td><a href="http://localhost:8080/M1/pdf.pdf">pdf.pdf</a></td>
        </tr>
        <tr>
          <th scope="row">3</th>
          <td>N</td>
          ...
          <td>*.xls</td>
         <td><a href="http://localhost:8080/M1/excel.xls" onkeyup="changeUrl(this)">excel.xls</a></td>
        </tr>
      </tbody>
    </table>
          <div class="blog-post">
