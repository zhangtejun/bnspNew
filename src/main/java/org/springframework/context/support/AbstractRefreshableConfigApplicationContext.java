	...
	public void setConfigLocations(String... locations) {
		if (locations != null) {
			...
			for (int i = 0; i < locations.length; i++) {
				// 自定义加载配置文件
				if(locations.length==1&&locations[0].equals("classpath:myConfig.properties")){
					
					 InputStream  is  =  this.getClass().getClassLoader().getResourceAsStream("/config/myConfig.properties");
					 ...
					 try {
						...
						this.logger.error("解析  myConfig.properties 错误");
					}
				}
